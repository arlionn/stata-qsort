...
and a usually faster version than {opt sort}.  This comes at a potentially
large memory penalty. Like {opt gsort}, it can arrange observations to be in
ascending or descending order.  This is mainly a proof-of-concept package
at the moment.
